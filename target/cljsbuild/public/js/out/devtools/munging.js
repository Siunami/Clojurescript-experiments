...
var o35840 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35840["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35841 = temp__5733__auto____$1;
return (o35841["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34857__auto__ = f;
return (o__34857__auto__["toString"]).call(o__34857__auto__);
} else {
return "";
}
}catch (e35842){var _ = e35842;
return "";
}});
...
try{var o__34857__auto___35844 = t;
(o__34857__auto___35844["cljs$lang$ctorPrWriter"]).call(o__34857__auto___35844,t,writer);
}catch (e35843){var __35845 = e35843;
}
...
var char_code = (function (){var o__34857__auto__ = (new String(char$));
return (o__34857__auto__["charCodeAt"]).call(o__34857__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34857__auto__ = String;
return (o__34857__auto__["fromCharCode"]).call(o__34857__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35846 = num_code;
switch (G__35846) {
case (1):
return (185);
...
var o__34857__auto__ = String;
return (o__34857__auto__["fromCharCode"]).call(o__34857__auto__,superscript_code);
});
/**
...
}catch (e35848){var _e__34864__auto__ = e35848;
return false;
}})())){
...
var vec__35849 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35849,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o35852 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35852["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35853 = temp__5733__auto____$1;
return (o35853["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35856){
var vec__35857 = p__35856;
var ns_detector = cljs.core.nth.call(null,vec__35857,(0),null);
...
var G__35863 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35864 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35863;
remaining_tokens = G__35864;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35854){
var G__35855 = cljs.core.first.call(null,seq35854);
var seq35854__$1 = cljs.core.next.call(null,seq35854);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35855,seq35854__$1);
}));
...
var vec__35868 = cljs.core.split_with.call(null,(function (p1__35867_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35867_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35868,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35868,(1),null);
...
var vec__35874 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35874,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35874,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35877 = cljs.core.rest.call(null,remaining_tokens);
var G__35878 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35877;
name_tokens = G__35878;
continue;
} else {
...
var vec__35881 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35881,(0),null);
var arity = cljs.core.nth.call(null,vec__35881,(1),null);
var vec__35884 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35884,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35884,(1),null);
var vec__35887 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35887,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35887,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35887,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35887,(3),null);
...
var vec__35893 = result;
var munged_ns = cljs.core.nth.call(null,vec__35893,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35893,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35893,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35893,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35893,(4),null);
var arity = cljs.core.nth.call(null,vec__35893,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__35897 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__35897,(0),null);
var args = cljs.core.nth.call(null,vec__35897,(1),null);
var vec__35900 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35900,(0),null);
var name = cljs.core.nth.call(null,vec__35900,(1),null);
...
var G__35903 = (arity + (1));
var G__35904 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35905){
var vec__35906 = p__35905;
var arity = cljs.core.nth.call(null,vec__35906,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35906,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__35909_SHARP_){
return cljs.core.get.call(null,arities,p1__35909_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__35910_SHARP_){
return cljs.core.drop.call(null,(2),p1__35910_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35913){
var vec__35914 = p__35913;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35914,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35911){
var G__35912 = cljs.core.first.call(null,seq35911);
var seq35911__$1 = cljs.core.next.call(null,seq35911);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35912,seq35911__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35922__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35922__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35922__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35922__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35923 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35923,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35923,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35923,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35923,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35923,(4),null);
var arity = cljs.core.nth.call(null,vec__35923,(5),null);
...
var o__34857__auto__ = f;
return (o__34857__auto__["getBasis"]).call(o__34857__auto__);
});
/**
...
}catch (e35927){var _e__34864__auto__ = e35927;
...
var G__35928 = (obj[cljs.core.first.call(null,path)]);
var G__35929 = cljs.core.rest.call(null,path);
obj = G__35928;
path = G__35929;
continue;
} else {
...
var _STAR_ = (function (accum,p__35930){
var vec__35931 = p__35930;
var bit = cljs.core.nth.call(null,vec__35931,(0),null);
var protocol = cljs.core.nth.call(null,vec__35931,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35934){
var vec__35935 = p__35934;
var ns = cljs.core.nth.call(null,vec__35935,(0),null);
var name = cljs.core.nth.call(null,vec__35935,(1),null);
var selector = cljs.core.nth.call(null,vec__35935,(2),null);
...
var post_process = (function (p__35939){
var vec__35940 = p__35939;
var munged_name = cljs.core.nth.call(null,vec__35940,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35940,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__35938_SHARP_){
return (obj[cljs.core.first.call(null,p1__35938_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1575922809399

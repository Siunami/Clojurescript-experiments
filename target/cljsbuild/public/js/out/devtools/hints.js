...
var map__40611 = top_item;
var map__40611__$1 = (((((!((map__40611 == null))))?(((((map__40611.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40611.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40611):map__40611);
var file = cljs.core.get.call(null,map__40611__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40611__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40611__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40610){var _e = e40610;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___40613 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___40613)){
var seen_errors_40614 = temp__5733__auto___40613;
if(cljs.core.truth_(seen_errors_40614.has(self))){
} else {
seen_errors_40614.add(self);

var temp__5735__auto___40615 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___40615)){
var sense_40616 = temp__5735__auto___40615;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40616)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1575922822310

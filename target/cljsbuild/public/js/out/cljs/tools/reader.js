...
var G__41015 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41015;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__41016 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41016,ch);
...
if(("\\" === ch__$1)){
var ch_41017__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_41017__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_41017__$2);
} else {
}

var G__41018 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__41018;
continue;
}
}
...
var vec__41026 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41026,(0),null);
var start_column = cljs.core.nth.call(null,vec__41026,(1),null);
...
var G__41029 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41029;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__41030 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__41031 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__41031);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__41030);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41032 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41032,(0),null);
var start_column = cljs.core.nth.call(null,vec__41032,(1),null);
...
var vec__41035 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41035,(0),null);
var end_column = cljs.core.nth.call(null,vec__41035,(1),null);
...
var vec__41038 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41038,(0),null);
var start_column = cljs.core.nth.call(null,vec__41038,(1),null);
...
var vec__41041 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41041,(0),null);
var end_column = cljs.core.nth.call(null,vec__41041,(1),null);
...
var vec__41044 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41044,(0),null);
var start_column = cljs.core.nth.call(null,vec__41044,(1),null);
...
var vec__41047 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41047,(0),null);
var end_column = cljs.core.nth.call(null,vec__41047,(1),null);
...
var sb = (function (){var G__41050 = (new goog.string.StringBuffer());
G__41050.append(initch);
...
var G__41052 = (function (){var G__41051 = sb;
G__41051.append(ch);

return G__41051;
})();
var G__41053 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41052;
ch = G__41053;
continue;
}
...
switch (G__41056) {
case "\\":
var G__41060 = (function (){var G__41057 = sb;
G__41057.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41057;
})();
var G__41061 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41060;
ch = G__41061;
continue;
...
break;
default:
var G__41062 = (function (){var G__41058 = sb;
G__41058.append(ch);

return G__41058;
})();
var G__41063 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41062;
ch = G__41063;
continue;
...
var vec__41064 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41064,(0),null);
var end_column = cljs.core.nth.call(null,vec__41064,(1),null);
...
var line = cljs.core.nth.call(null,vec__41067,(0),null);
var column = cljs.core.nth.call(null,vec__41067,(1),null);
...
var line = cljs.core.nth.call(null,vec__41072,(0),null);
var column = cljs.core.nth.call(null,vec__41072,(1),null);
...
var vec__41077 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41077,(0),null);
var column = cljs.core.nth.call(null,vec__41077,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41082 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41082,(0),null);
var start_column = cljs.core.nth.call(null,vec__41082,(1),null);
...
var vec__41085 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41085,(0),null);
var end_column = cljs.core.nth.call(null,vec__41085,(1),null);
...
var G__41088 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41088,true,null,opts,pending_forms);
...
var G__41089 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41089)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41089)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41089)){
...
var _STAR_suppress_read_STAR__orig_val__41090 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41091 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41091);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41090);
}});
...
var G__41092 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41092,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41092,rdr,first_line);
...
var G__41096 = matched;
var G__41097 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__41096;
finished = G__41097;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__41098 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41099 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41099);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41098);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__41100 = cljs.tools.reader.arg_env;
var arg_env_temp_val__41101 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__41101);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__41102 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41102,"(");
...
var G__41103 = (i + (1));
var G__41104 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4185__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__41100);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__41105 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__41105);
...
var G__41106 = cljs.core.next.call(null,s__$1);
var G__41107 = ret;
s__$1 = G__41106;
r = G__41107;
continue;
...
var G__41108 = cljs.core.next.call(null,s);
var G__41109 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__41108;
key_vals = G__41109;
continue;
} else {
...
var gensym_env_orig_val__41114 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__41115 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__41115);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__41114);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__41116 = token;
var G__41116__$1 = (((G__41116 == null))?null:cljs.core.subs.call(null,G__41116,(1)));
var G__41116__$2 = (((G__41116__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41116__$1));
var G__41116__$3 = (((G__41116__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41116__$2));
var G__41116__$4 = (((G__41116__$3 == null))?null:cljs.core.symbol.call(null,G__41116__$3));
if((G__41116__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__41116__$4);
}
})():(function (){var G__41117 = token;
var G__41117__$1 = (((G__41117 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41117));
if((G__41117__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41117__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e41124){if((e41124 instanceof Error)){
var e = e41124;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41128,reader){
...
var eof = cljs.core.get.call(null,map__41129__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1575922823946

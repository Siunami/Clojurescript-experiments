(ns testproject.core
  (:require
   ...
   [testproject.components.marketplace :as mkt]
   [testproject.components.datastructures :as ds]
   [testproject.components.burritomaps :as bmaps]))
...
(defn page-for [route]
  (case route
    ...
    :datastructures #'ds/render-structures
    :burritomaps #'bmaps/render-map))
      ...
      [:div
       [:header
        [:p [:a {:href (path-for :index)} "Home"] " | "
         ...
         [:a {:href (path-for :marketplace)} "Marketplace"] " | "
         [:a {:href (path-for :datastructures)} "Data Structures"] " | "
         [:a {:href (path-for :burritomaps)} "Burrito Maps"]]]
       [page]
       ])))

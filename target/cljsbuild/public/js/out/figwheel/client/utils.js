...
return (new CustomEvent(event_name,(function (){var obj41344 = ({"detail":data});
return obj41344;
})()));
} else {
...
var f = (function (){var pred__41351 = cljs.core._EQ_;
var expr__41352 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41351.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41352))){
return (function (p1__41345_SHARP_){
return console.warn(p1__41345_SHARP_);
});
} else {
if(cljs.core.truth_(pred__41351.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41352))){
return (function (p1__41346_SHARP_){
return console.debug(p1__41346_SHARP_);
});
} else {
if(cljs.core.truth_(pred__41351.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41352))){
return (function (p1__41347_SHARP_){
return console.error(p1__41347_SHARP_);
});
} else {
return (function (p1__41348_SHARP_){
return console.log(p1__41348_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41355){
...
var eval_fn = cljs.core.get.call(null,map__41356__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__41358_SHARP_){
return new_def.callback(p1__41358_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__41359){
var vec__41360 = p__41359;
var ky = cljs.core.nth.call(null,vec__41360,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1575922824550

...
var G__9747 = o;
goog.object.set(G__9747,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__9751 = o;
goog.object.set(G__9751,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__9753__i < G__9753__a.length) {G__9753__a[G__9753__i] = arguments[G__9753__i + 0]; ++G__9753__i;}
  args = new cljs.core.IndexedSeq(G__9753__a,0,null);
} 
...
var G__9755 = props;
var G__9755__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9755,cljs.core.cst$kw$id,id):G__9755);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9755__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__9755__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9756 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9756,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9756;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__9757){
var map__9758 = p__9757;
var map__9758__$1 = (((((!((map__9758 == null))))?(((((map__9758.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9758.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9758):map__9758);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9758__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__9760_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__9760_SHARP_);
}));
} else {
return null;
}
...
var vec__9763 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9763,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9763,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9763,(2),null);
...
var temp__5739__auto___9767 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___9767 == null)){
} else {
var key_9768 = temp__5739__auto___9767;
...
var temp__5739__auto___9769 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___9769 == null)){
} else {
var key_9770 = temp__5739__auto___9769;
(jsprops.key = key_9770);
}
...
var G__9771 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__9771) : reagent.impl.template.as_element.call(null,G__9771));
} else {
var temp__5739__auto___9772 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___9772 == null)){
} else {
var key_9773 = temp__5739__auto___9772;
(jsprops.key = key_9773);
}
...
var G__9775 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__9775)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__9775)){
return x;
} else {
...
var len__4789__auto___9778 = arguments.length;
var i__4790__auto___9779 = (0);
while(true){
if((i__4790__auto___9779 < len__4789__auto___9778)){
args__4795__auto__.push((arguments[i__4790__auto___9779]));

var G__9780 = (i__4790__auto___9779 + (1));
i__4790__auto___9779 = G__9780;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9776){
var G__9777 = cljs.core.first(seq9776);
var seq9776__$1 = cljs.core.next(seq9776);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9777,seq9776__$1);
}));
...
break;
default:
var G__9783 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__9783;
continue;
...
var ctx = ({});
var vec__9785 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9785,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9785,(1),null);
...
var G__9788 = (cljs.core.count(argv) - first_child);
switch (G__9788) {
case (0):
...
break;
case (1):
var G__9789 = component;
var G__9790 = jsprops;
var G__9791 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__9789,G__9790,G__9791);
